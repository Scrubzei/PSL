  ...
  template: `
    <div class="welcome-modal">
      ...
      <div class="modal-content">
        ...
        <p class="message">
          1v1 Leaderboards is still a work in progress. Most of what you see here
        ...
        <p class="message">
          ...
          cool for the 1v1 community.
        </p>

        <a href="https://discord.gg/1v1leaderboards" target="_blank" rel="noopener" class="discord-btn">
