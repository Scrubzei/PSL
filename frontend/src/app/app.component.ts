...
@Component({
  ...
  template: `
    ...
    <div class="scene" [class.animating]="isAnimating" [class.hof-open]="hofService.isOpen()">
      <div class="cube" #cube>
  ...
  styles: [`
    ...
    .bg-overlay {
      ...
      height: 100%;
      background:
        radial-gradient(ellipse at 50% 30%, rgba(255, 140, 0, 0.15) 0%, transparent 60%),
...
export class AppComponent implements OnInit {
  ...
  private noNavbarRoutes = ['/discord-callback', '/username-selection', '/dev-login'];
  ...
  private openHof(): void {
    ...
    setTimeout(() => {
      ...
      gsap.fromTo(this.cube.nativeElement,
        { rotateY: 0 },
        {
          rotateY: -90,
          duration: 2,
